...
export const TagNew =(props:Props)=>{
    return(
        <><div className={style.wrapper}>
            <button className={style.tag_button}>
                <div className={style.tag_text__wrapper}>
               <span className={style.tag_text}> {props.label} </span>
              <span className={style.tag_span}> <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
